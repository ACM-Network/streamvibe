...
export const MOCK_VIDEOS: Video[] = [
  {
    ...
    category: 'News',
    url: "https://dyjmyiv3bp2ez.cloudfront.net/pub-iotv9telcmjhcs/liveabr/pub-iotv9telcmjhcs/live_720p/chunks.m3u8",
    is4K: true,
    isHDR: true,
    chapters: [
  ...
  },
  {
    ...
    description: 'Watch For Free',
    thumbnail: 'https://i.ytimg.com/vi/L0RktSIM980/maxresdefault.jpg',
    duration: '🔴LIVE',
    ...
    channelAvatar: 'https://upload.wikimedia.org/wikipedia/en/b/ba/Ntv_India_official_logo.png',
    channelSubscribers: 22000000,
    tags: ['Mountain Biking', 'Extreme Sports', 'Red Bull', 'Rampage'],
    category: 'Sports',
    url: 'https://yuppnimresmum.akamaized.net/110322/ntv/110322/ntv_1800/hdntl=exp=1777275966~acl=%2f*~data=hdntl~hmac=63c31cdf4ee92c87021f02ebce906844559d5b8da1a08cca9ef0f26b6c0eabbd/chunks.m3u8',
    isLive: false,
    is4K: true,
